...
def _calculate_monthly_averages(daily_summaries,employee_holidays,num_days_in_month):
    try:
        ...
        for employee,days in employee_monthly.items():
            ...
            holiday_count=len(employee_holidays.get(employee,[]))

            # Number of days in month monthdays minus holidays
            ...
            monthly_results.append({
                ...
                'holidays_in_month': holiday_count,
...
def fetchmonthly(selected_date=None):
    try:
        ...
        monthly_averages=_calculate_monthly_averages(daily_summaries,employee_holidays,num_days_in_month)
