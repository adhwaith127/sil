...
def _calculate_weekly_averages(daily_summaries,employee_holidays):
    try:
        ...
        for employee,days in employee_weekly.items():
            ...
            weekly_results.append({
                ...
                'holidays_in_week': holiday_count,
...
def fetchWeekly(selected_date=None):
    try:
        ...
        weekly_averages=_calculate_weekly_averages(daily_summaries,employee_holidays)
