...
def _create_summary_with_effective_working_days(daily_records, period_type, start_date, end_date, employee_holidays, employee_leaves, employee_shift_info, is_current_period=False):
    try:
...
# Calculate week/month boundaries with refined current vs past logic
    ...
    try:
        ...
        if weekly_data:
            summary = _create_summary_with_effective_working_days(
                weekly_data, 'weekly', boundaries['week_start'], boundaries['summary_week_end'], 
        ...
        if monthly_data:
            summary = _create_summary_with_effective_working_days(
                monthly_data, 'monthly', boundaries['month_start'], boundaries['summary_month_end'], 
